 ...
 */
function fastest_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['fastest_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('fastest sample setting'),
  '#default_value' => theme_get_setting('fastest_example'),
